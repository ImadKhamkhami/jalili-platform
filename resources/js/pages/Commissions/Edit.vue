...
const form = useForm({
  ...
  commission_date: props.commission.commission_date,
  broker_name: props.commission.broker_name ?? '',
  notes: props.commission.notes ?? '',
})

function submit() {
  form.put(`/commissions/${props.commission.id}`, {
    preserveScroll: true,
  })
}
