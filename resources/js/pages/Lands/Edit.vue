...
const imagePreview = ref(
  props.land.image ? `/storage/${props.land.image}` : null
)

/* ================= FORM ================= */
const form = useForm({
  project_id: props.land.project_id,
  land_number: props.land.land_number,
  road_type: props.land.road_type,
  view_type: props.land.view_type,

  area: props.land.area,
  price_per_m2: props.land.price_per_m2,
  discount: props.land.discount ?? 0,

  status: props.land.status,

  customer_name: props.land.customer_name ?? '',
  customer_id: props.land.customer_id ?? '',
  customer_phone: props.land.customer_phone ?? '',
...
<template>
<AppLayout title="تعديل قطعة أرضية">
        ...
        <div v-show="activeStep === 1" class="space-y-6">
          ...
          <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div>
              ...
              <p v-if="form.errors.project_id" class="text-red-600 text-sm">
    ...
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-2xl shadow p-6">
        ...
        <label class="border-2 border-dashed h-56 flex items-center justify-center cursor-pointer rounded-xl">
          ...
          <span v-if="!imagePreview">اضغط لتغيير الصورة</span>
